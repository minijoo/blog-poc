---
  ...
  coverImage: 'https://d1goytf13un2gh.cloudfront.net/assets/food/bus.jpeg'
  date: '2023-09-26'
  author: 
    name: Jordy
    picture: '/assets/blog/authors/jord.jpg'
  ogImage:
    url: 'https://d1goytf13un2gh.cloudfront.net/assets/food/bus.jpeg'
---
...
<center>
  <PhotoGallery slides={udonPhotos} />
</center>
<br />
<hr />
...
<center>
  <PhotoGallery slides={onBbqPhotos} />
</center>
<br />
<hr />
...
**Notes** - The best 순댓국 in the world. Broth is made only from head of the pig, daily. No pork stench. Garlic and other vegetables are incredibly fresh and crunchy. 쌈장 is simple. The meal is around 9,000. Bottle of soju is a must. They also only serve cheek, ear, and jowl cuts, which all come from the head.   

<center>
  <PhotoGallery slides={ongPhotos} />
</center>
<br />
<center>
  <iframe
...
<center>
  <PhotoGallery slides={gudeljangPhotos} />
</center>
<br />
<hr />
...
<center>
  <PhotoGallery slides={daedoPhotos} />
</center>
<br />
<hr />
...
<center>
  <PhotoGallery slides={kimchiPhotos} />
</center>
<br />
<hr />
...
<center>
  <PhotoGallery slides={hwagyungPhotos} />
</center>
<br />
<hr />
...
**Notes** - At the center of a new outdoor shopping area that screams "This is a terrace!" is this restaurant with a surprisingly extensive menu. Calamari is fried using japanese tempura-frying technique. Despite the high price tag, it gets a near 8.0 score because my belief is that the calamari is a good pulse-setter of a restuarant, and in this case the calamari was a near 8.0.<sup>[1](#footnotes)</sup>. 

<center>
  <PhotoGallery slides={ivyPhotos} />
</center>
<br />
<hr />
...
<center>
  <PhotoGallery slides={midoriPhotos} />
</center>
<br />
<hr />
...
**Notes** - The old man splurged for high-end itamae sushi to celebrate the missus' birthday and I tagged along. 30,000 yen per person, it is an indulgent experience where all you have to do is bring chopsticks up from the plate to your mouth, and lift then tilt glasses of beverage for a sip every so often as a plate is repeatedly cleared and replaced by a succeeding one, atop which stands a hand-crafted piece of edible creation. Having said that, if I had to foot a price tag of 30,000 yen, things could get a little harder to swallow. I think that my preferred sushi experience is one that is majoritively sashimi and nigiri with less pickled dishes. Happy birthday 엄마!
